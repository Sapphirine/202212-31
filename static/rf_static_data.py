...
model_pipeline_path = 'gs://{}/models/static/rf_model_pipeline'.format(bucket)
...
pipeline = Pipeline(stages=[tokenizer, cv, idf, label_stringIdx, rf_model])
...
data = [(f"{time.strftime('%y_%d_%m')}",accuracy,"rf")]
