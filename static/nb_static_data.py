...
model_pipeline_path = 'gs://{}/models/static/nb_model_pipeline'.format(bucket)
...
pipeline = Pipeline(stages=[tokenizer, cv, idf, label_stringIdx, nb_model])
...
data = [(f"{time.strftime('%y_%d_%m')}",accuracy,"nb")]
