...
videos_path = 'gs://{}/static_data/USvideos.csv'.format(bucket)
accuracy_table_name = 'bda.daily_accuracy'
table_name = 'bda.preprocessed_static_data'
final_table_name = 'bda.final_static_data'
...
combined_df.createOrReplaceTempView("kaggle_data")
test_op = spark.sql('SELECT * FROM kaggle_data')
test_op.show()
